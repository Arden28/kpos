...
<div class="col-sm-6 col-lg-3">
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex align-items-baseline">
          <div class="h1 mb-0 me-2">{{ format_currency($purchase) }}</div>
          {{-- <div class="me-auto">
      ...
      <div id="chart-purchase-bg" class="chart-sm"></div>
    </div>
  </div>
  ...
  <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
          window.ApexCharts && (new ApexCharts(document.getElementById('chart-purchase-bg'), {
              chart: {
                  type: "area",
                  fontFamily: 'inherit',
                  height: 40.0,

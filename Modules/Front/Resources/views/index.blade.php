...
@section('page_title', 'Commençons à développer votre Commerce')

@section('open_graph')
    <meta property="og:title" content="Commençons à développer votre Business | Koverae.com">
    <meta property="og:description" content="">
    <meta property="og:image" content="{{ asset('images/favicon.png')}}">
    <meta property="og:url" content="www.koverae.com">
@endsection
...
<section class="pt-7">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="{{ asset('front/assets/img/hero/hero-img.png')}}" alt="" /></div>
    </div>
  </div>
</section>
...
<section class="pt-5 pt-md-9 mb-6" id="feature">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('front/assets/img/category/icon1.png')}}" width="75" alt="Feature" />
        <h4 class="mb-3">First click tests</h4>
        <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
      </div>
      <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('front/assets/img/category/icon2.png')}}" width="75" alt="Feature" />
      ...
      <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('front/assets/img/category/icon3.png')}}" width="75" alt="Feature" />
        <h4 class="mb-3">Preference tests</h4>
        <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
      </div>
      <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('front/assets/img/category/icon4.png')}}" width="75" alt="Feature" />
...
<section class="pt-5" id="validation">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6"><img class="img-fluid" src="{{ asset('front/assets/img/validation/validation.png')}}" alt="" /></div>
    </div>
  </div><!-- end of .container-->
...
<section class="pt-5" id="manager">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6"><img class="img-fluid" src="{{ asset('front/assets/img/manager/manager.png')}}" alt="" /></div>
      <div class="col-lg-6">
        ...
        <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="{{ asset('front/assets/img/manager/tick.png')}}" width="35" alt="tick" />
...
<section class="pt-5" id="marketer">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6"><img class="img-fluid" src="{{ asset('front/assets/img/marketer/marketer.png')}}" alt="" /></div>
    </div>
  </div><!-- end of .container-->
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="card"><img class="card-img-top" src="{{ asset('front/assets/img/marketing/marketing01.png')}}" alt="" />
      ...
      <div class="col-md-4 mb-4">
        <div class="card"><img class="card-img-top" src="{{ asset('front/assets/img/marketing/marketing02.png')}}" alt="" />
          <div class="card-body ps-0">
            <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
      ...
      <div class="col-md-4 mb-4">
        <div class="card"><img class="card-img-top" src="{{ asset('front/assets/img/marketing/marketing03.png')}}" alt="" />
          <div class="card-body ps-0">
            <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
...
@section('third_party')
    <div class="modal fade" id="popupVideo" tabindex="-1" aria-labelledby="popupVideo" aria-hidden="true">
        ...
        <div class="modal-content">
            <iframe class="rounded" width="100%" height="500" src="https://www.youtube.com/embed/bX6wcb4vjQ4" title="Akaunting 3.0: Small Business Accounting made easy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

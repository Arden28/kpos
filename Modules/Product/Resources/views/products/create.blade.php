                                ...
                                <div class="row">
                                    <div class="col-8">
                                      <div class="mb-3">
                                        ...
                                        <input type="text" style="font-size: 28px; font-weight: 500" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_name" placeholder="{{ __('Nom du Produit') }}" required value="{{ old('product_name') }}">
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                        <div class="mb-3 d-flex align-items-center">
                                            <input type="checkbox" class="form-inline form-checkbox" name="can_be_sold" checked value="{{ true }}">
                                    ...
                                    <div class="col-3">
                                        <div class="mb-3 d-flex align-items-center">
                                            <input type="checkbox" class="form-inline form-checkbox" name="can_be_purchased" checked value="{{ true }}">
                                    ...
                                    <div class="col-3">
                                        <div class="mb-3 d-flex align-items-center">
                                            <input type="checkbox" style="font-size: 28px; font-weight: 500" class="form-inline form-checkbox" name="can_be_rented" value="{{ true }}">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_code" required value="{{ old('product_code') }}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="mb-3">
                                        ...
                                        <input id="product_cost" type="text" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_cost" value="{{ old('product_cost') }}">
                                      </div>
                                    </div>
                                    <div class="col-lg-6">
                                      <div class="mb-3">
                                        ...
                                        <input id="product_price" type="text" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_price" required value="{{ old('product_price') }}">
                                      </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_quantity" required value="{{ old('product_quantity') }}" min="1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_stock_alert" required value="{{ old('product_stock_alert') }}" min="0" max="100">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline" name="product_order_tax" value="{{ old('product_order_tax') }}" min="1">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="product_note" id="product_note" rows="4 " class="form-inline form-control-plaintext border-0 rounded-0 border-bottom border-none no-outline"></textarea>
                                        </div>
                                    </div>

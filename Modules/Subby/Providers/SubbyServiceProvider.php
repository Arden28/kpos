...
namespace Modules\Subby\Providers;
...
use Modules\Subby\Repositories\PlanRepository;
use Modules\Subby\Repositories\SubscriptionRepository;
...
class SubbyServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleName = 'Subby';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'subby';

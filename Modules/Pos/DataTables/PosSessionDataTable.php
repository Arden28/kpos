...
class PosSessionDataTable extends DataTable
{
    ...
    public function query(PhysicalPosSession $model) {
        ...
        return $model->orderBy('id', 'DESC')->newQuery()->with('pos', 'cashier');// A modifier en fonction de la company en cours d'utilisation
    ...
    protected function filename() {
        return 'Pdv_sessions' . date('d m-Y H:i:s');
    }

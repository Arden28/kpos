    ...
    <form id="session-form"  wire:submit.prevent="submit">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="datetime-local" id="date" class="form-control" wire:model="start_date" placeholder="Your report name">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="mb-3">
                ...
                {{-- <input id="start_amount" type="text" placeholder="{{ __("Combien y'a-t-il dans la Caisse ?") }}" class="form-control" wire:model="start_amount"> --}}

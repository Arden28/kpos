                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="company_email" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label for="company_phone">{{ __('Company Phone') }} <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="company_phone" value="" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="default_currency_position" id="default_currency_position" class="form-control" required>
                                                ...
                                                <option value="suffix">{{ __('Suffix') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="notification_email" value="" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" name="footer_text" class="form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
